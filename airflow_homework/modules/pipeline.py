...
def pipeline() -> None:
    ...
    df_model = pd.read_csv('/Users/Alexandr/airflow/airflow_homework/data/train/homework.csv')

    #df_model = pd.read_csv(f'{path}/data/train/homework.csv')
    ...
    best_pipe.fit(X, y)
    model_filename = f'/Users/Alexandr/airflow/airflow_homework/data/models/cars_pipe_{datetime.now().strftime("%Y%m%d%H%M")}.pkl'
